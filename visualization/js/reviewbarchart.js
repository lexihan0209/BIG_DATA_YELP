function drawReviewBarChart(id){
	...
	var yScale = d3.scale.linear().range([height,0]).domain([12006,2560000]);
	...
	d3.csv("data/user_review_by_year.csv",function(error,data){
		
		createReviewBar(g,data,colorbrewer['Paired'][12][7]);
	})

}

function createReviewBar(g,data,color){
